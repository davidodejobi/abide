...
class ReadingDays extends Table with TableInfo<ReadingDays, ReadingDaysData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ReadingDays(this.attachedDatabase, [this._alias]);
  ...
  @override
  ReadingDaysData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ReadingDaysData(
  ...
  @override
  ReadingDays createAlias(String alias) {
    return ReadingDays(attachedDatabase, alias);
  }
}

class ReadingDaysData extends DataClass implements Insertable<ReadingDaysData> {
  final String dateKey;
  final String source;
  final DateTime completedAt;
  const ReadingDaysData(
  ...
  factory ReadingDaysData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ReadingDaysData(
  ...
  ReadingDaysData copyWithCompanion(ReadingDaysCompanion data) {
    return ReadingDaysData(
  ...
  @override
  String toString() {
    return (StringBuffer('ReadingDaysData(')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ReadingDaysData &&
          other.dateKey == this.dateKey &&
          other.source == this.source &&
          other.completedAt == this.completedAt);
}

class ReadingDaysCompanion extends UpdateCompanion<ReadingDaysData> {
  ...
  ReadingDaysCompanion.insert({
    ...
    this.rowid = const Value.absent(),
        ...
        source = Value(source),
        completedAt = Value(completedAt);
  static Insertable<ReadingDaysData> custom({
...
class PlanSubscriptions extends Table
    with TableInfo<PlanSubscriptions, PlanSubscriptionsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  PlanSubscriptions(this.attachedDatabase, [this._alias]);
  ...
  @override
  PlanSubscriptionsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PlanSubscriptionsData(
  ...
  @override
  PlanSubscriptions createAlias(String alias) {
    return PlanSubscriptions(attachedDatabase, alias);
  }
}

class PlanSubscriptionsData extends DataClass
    implements Insertable<PlanSubscriptionsData> {
  final String planId;
  final String startDateKey;
  final bool isActive;
  const PlanSubscriptionsData(
  ...
  factory PlanSubscriptionsData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return PlanSubscriptionsData(
  ...
  PlanSubscriptionsData copyWith(
  ...
  PlanSubscriptionsData copyWithCompanion(PlanSubscriptionsCompanion data) {
    return PlanSubscriptionsData(
  ...
  @override
  String toString() {
    return (StringBuffer('PlanSubscriptionsData(')
          ..write('planId: $planId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PlanSubscriptionsData &&
          other.planId == this.planId &&
          other.startDateKey == this.startDateKey &&
          other.isActive == this.isActive);
}

class PlanSubscriptionsCompanion
    extends UpdateCompanion<PlanSubscriptionsData> {
  ...
  PlanSubscriptionsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
        ...
        startDateKey = Value(startDateKey);
  static Insertable<PlanSubscriptionsData> custom({
...
class PlanDayProgress extends Table
    with TableInfo<PlanDayProgress, PlanDayProgressData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  PlanDayProgress(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  late final GeneratedColumn<String> planId = GeneratedColumn<String>(
  ...
  @override
  PlanDayProgress createAlias(String alias) {
    return PlanDayProgress(attachedDatabase, alias);
  }
}
...
class DatabaseAtV4 extends GeneratedDatabase {
  ...
  late final ReadingDays readingDays = ReadingDays(this);
  late final PlanSubscriptions planSubscriptions = PlanSubscriptions(this);
  late final PlanDayProgress planDayProgress = PlanDayProgress(this);
  @override
